...
public class RootResource extends RepresentationModel<RootResource> {
    ...
    public RootResource() {
        ...
        Link leasgingContractsOverviewLink = linkTo(methodOn(LeasingContractController.class).getLeasingContractsOverview()).withRel("leasingContractsOverview");


        add(selfLink, vehicleBrandsLink, vehiclesLink, customersLink, leasgingContractsLink, leasgingContractsOverviewLink);
    }
}
